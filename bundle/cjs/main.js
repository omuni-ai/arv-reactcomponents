...
function (_PureComponent) {
  ...
  function LazyImg(props) {
    ...
    _this.isInViewport = _this.isInViewport.bind(_assertThisInitialized(_this));
    _this.isImageInView = _this.isImageInView.bind(_assertThisInitialized(_this));
    _this.setContext = _this.setContext.bind(_assertThisInitialized(_this));
    _this.calcElemVals = _this.calcElemVals.bind(_assertThisInitialized(_this));
    _this.initLazyLoad = _this.initLazyLoad.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(LazyImg, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          otherProps = _objectWithoutProperties(_this$props, ["onWinLoad", "index", "offset", "className", "src", "alt", "onLoad", "onError", "parentElement"]);
