...
var setUrlParameter = function setUrlParameter(url, name, value) {
  ...
  if (url.match(regex)) {
    var replaceWith = value && "$1" + name + "=" + value + "$2" || separator;
    return url.replace(regex, replaceWith);
  }

  var returnUrl = setUrlParameter("" + url + separator + name + "=" + value, name, value);
...
var Ripple = function (_PureComponent) {
  ...
  _createClass(Ripple, [{
    ...
    value: function modifyChildren(child) {
      ...
      var clonedElement = react_1(child, {
...
var Close = function (_PureComponent) {
  _inherits$1(Close, _PureComponent);

  function Close() {
    _classCallCheck$1(this, Close);

    return _possibleConstructorReturn$1(this, (Close.__proto__ || Object.getPrototypeOf(Close)).apply(this, arguments));
  }

  _createClass$1(Close, [{
    key: "render",
    value: function render() {
      var _props = this.props,
          className = _props.className,
          otherProps = _objectWithoutProperties$1(_props, ["className"]);

      return react.createElement(
        Button,
        _extends$1({ className: "nwc-close " + className }, otherProps),
        "\xD7"
      );
    }
  }]);
...
var GridContainer = function (_PureComponent) {
  _inherits$2(GridContainer, _PureComponent);

  function GridContainer() {
    _classCallCheck$2(this, GridContainer);

    return _possibleConstructorReturn$2(this, (GridContainer.__proto__ || Object.getPrototypeOf(GridContainer)).apply(this, arguments));
  }

  _createClass$2(GridContainer, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          otherProps = _objectWithoutProperties$2(_props, ["className", "strict", "children"]);
...
var GridRow = function (_PureComponent) {
  _inherits$3(GridRow, _PureComponent);

  function GridRow() {
    _classCallCheck$3(this, GridRow);

    return _possibleConstructorReturn$3(this, (GridRow.__proto__ || Object.getPrototypeOf(GridRow)).apply(this, arguments));
  }

  _createClass$3(GridRow, [{
    key: "componentDidMount",
    value: function componentDidMount() {
    ...
    value: function render() {
      ...
      var _props = this.props,
          className = _props.className,
          children = _props.children,
          otherProps = _objectWithoutProperties$3(_props, ["className", "children"]);
...
var GridColumn = function (_PureComponent) {
  _inherits$4(GridColumn, _PureComponent);

  function GridColumn() {
    _classCallCheck$4(this, GridColumn);

    return _possibleConstructorReturn$4(this, (GridColumn.__proto__ || Object.getPrototypeOf(GridColumn)).apply(this, arguments));
  }

  _createClass$4(GridColumn, [{
    key: "componentDidMount",
    value: function componentDidMount() {
    ...
    value: function render() {
      ...
      var _props = this.props,
          className = _props.className,
          children = _props.children,
          otherProps = _objectWithoutProperties$4(_props, ["className", "children"]);
...
function Img(props) {
  var className = props.className,
      ...
      otherProps = _objectWithoutProperties$5(props, ["className", "src", "alt", "onLoad", "onError"]);

  return react.createElement("img", _extends$5({
...
var LazyImg = function (_PureComponent) {
  _inherits$5(LazyImg, _PureComponent);

  _createClass$5(LazyImg, null, [{
    key: "triggerLoad",
  ...
  function LazyImg(props) {
    _classCallCheck$5(this, LazyImg);

    var _this = _possibleConstructorReturn$5(this, (LazyImg.__proto__ || Object.getPrototypeOf(LazyImg)).call(this, props));
  ...
  _createClass$5(LazyImg, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          otherProps = _objectWithoutProperties$6(_props, ["onWinLoad", "index", "offset", "className", "src", "alt", "onLoad", "onError", "parentElement"]);
...
function Label(props) {
  var htmlFor = props.htmlFor,
      children = props.children,
      otherProps = _objectWithoutProperties$7(props, ["htmlFor", "children"]);

  return react.createElement(
    "label",
    _extends$7({ htmlFor: htmlFor }, otherProps),
...
var Input$1 = function (_PureComponent) {
  _inherits$6(Input, _PureComponent);

  function Input(props) {
    _classCallCheck$6(this, Input);

    var _this = _possibleConstructorReturn$6(this, (Input.__proto__ || Object.getPrototypeOf(Input)).call(this, props));
  ...
  _createClass$6(Input, [{
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          otherProps = _objectWithoutProperties$8(_props2, ["id", "className", "type", "inputRef", "validateWithPattern"]);

      if (!this.isCheckTypes) {
        return react.createElement("input", _extends$8({
          id: id || this.inputId,
      ...
      return react.createElement(
        ...
        react.createElement(
          ...
          react.createElement("input", _extends$8({
            id: id || this.inputId,
            type: type,
            tabIndex: "0",
            ref: inputRef
        ...
        react.createElement("i", { className: "" + this.cloneClassName })
      );
    }
  }, {
    key: "cloneClassName",
...
var Autocomplete = function (_Component) {
  _inherits$7(Autocomplete, _Component);

  function Autocomplete(props) {
    _classCallCheck$7(this, Autocomplete);

    var _this = _possibleConstructorReturn$7(this, (Autocomplete.__proto__ || Object.getPrototypeOf(Autocomplete)).call(this, props));
  ...
  _createClass$7(Autocomplete, [{
    ...
    value: function renderListItems(inpVal, inpList, renderList) {
      ...
      return this.state.isActive && filteredList.length > 0 && inpVal.length >= minTextLength ? react.createElement(
        "ul",
        {
    ...
    value: function render() {
      var _props = this.props,
          ...
          otherProps = _objectWithoutProperties$9(_props, ["className", "inpList", "getSelection", "renderInput", "renderList", "minTextLength", "selectedIndex"]);

      var elem = renderInput();

      return react.createElement(
        "div",
        _extends$9({ className: "nwc-autocomplete " + className }, otherProps),
...
var Select = function (_PureComponent) {
  _inherits$8(Select, _PureComponent);

  function Select(props) {
    _classCallCheck$8(this, Select);

    var _this = _possibleConstructorReturn$8(this, (Select.__proto__ || Object.getPrototypeOf(Select)).call(this, props));
  ...
  _createClass$8(Select, [{
    ...
    value: function renderListItems(inpVal, inpList, renderList) {
      ...
      return this.state.isActive ? react.createElement(
        "ul",
        {
...
var Masonry$$1 = function (_PureComponent) {
  _inherits$9(Masonry$$1, _PureComponent);

  function Masonry$$1(props) {
    _classCallCheck$9(this, Masonry$$1);

    var _this = _possibleConstructorReturn$9(this, (Masonry$$1.__proto__ || Object.getPrototypeOf(Masonry$$1)).call(this, props));
...
function Qa(a,b,c){Ra[a]?E$1("100",a):void 0;Ra[a]=b;Sa[a]=b.eventTypes[c].dependencies;}var Oa=[],Pa={},Ra={},Sa={};function Ta(a){La?E$1("101"):void 0;La=Array.prototype.slice.call(a);Na();}function Ua(a){var b=!1,c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];Ma.hasOwnProperty(c)&&Ma[c]===d||(Ma[c]=d,b=!0);}b&&Na();}
...
function rd(a){var b=a.targetInst;do{if(!b){a.ancestors.push(b);break}var c;for(c=b;c["return"];)c=c["return"];c=3!==c.tag?null:c.stateNode.containerInfo;if(!c)break;a.ancestors.push(b);b=pb(c);}while(b);for(c=0;c<a.ancestors.length;c++)b=a.ancestors[c],sd(a.topLevelType,b,a.nativeEvent,wc(a.nativeEvent));}var td=!0,sd=void 0;function ud(a){td=!!a;}function U$1(a,b,c){return c?EventListener_1.listen(c,b,vd.bind(null,a)):null}function wd(a,b,c){return c?EventListener_1.capture(c,b,vd.bind(null,a)):null}
...
var ModalContainer = function (_PureComponent) {
  _inherits$a(ModalContainer, _PureComponent);

  _createClass$a(ModalContainer, null, [{
    key: "isModalOpen",
  ...
  function ModalContainer(props) {
    _classCallCheck$a(this, ModalContainer);

    var _this = _possibleConstructorReturn$a(this, (ModalContainer.__proto__ || Object.getPrototypeOf(ModalContainer)).call(this, props));
  ...
  _createClass$a(ModalContainer, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          otherProps = _objectWithoutProperties$b(_props, ["className", "children", "onClose", "preventfix"]);
...
function Modal(props) {
  var isOpen = props.isOpen,
      otherProps = _objectWithoutProperties$c(props, ["isOpen"]);

  if (isOpen) {
    return reactDom.createPortal(react.createElement(ModalContainer, otherProps), document.querySelector(".nwc-modal-holder"));
  }
  return null;
}
...
function ToastrList(props) {
  var item = props.item,
      ...
      otherProps = _objectWithoutProperties$d(props, ["item", "hideToastr"]);
...
function ToastrContainer(props) {
  ...
  return react.createElement(
    ...
    react.createElement(
      ...
      [].concat(_toConsumableArray$1(toastrList)).reverse().map(function (item, index) {
        if (index < limitTo) {
          return react.createElement(ToastrList, { item: item, key: item.id, hideToastr: hideToastr });
        }
...
var Toastr = function (_Component) {
  _inherits$b(Toastr, _Component);

  function Toastr(props) {
    _classCallCheck$b(this, Toastr);

    var _this = _possibleConstructorReturn$b(this, (Toastr.__proto__ || Object.getPrototypeOf(Toastr)).call(this, props));
  ...
  _createClass$b(Toastr, [{
    key: "render",
    value: function render() {
      var toastrList = this.state.toastrList;


      return reactDom.createPortal(react.createElement(ToastrContainer, {
        toastrList: toastrList,
...
reactDom.render(react.createElement(Toastr, null), document.querySelectorAll(".nwc-toastr-holder")[0]);
...
var Carousel = function (_PureComponent) {
  _inherits$c(Carousel, _PureComponent);

  function Carousel(props) {
    _classCallCheck$c(this, Carousel);

    var _this = _possibleConstructorReturn$c(this, (Carousel.__proto__ || Object.getPrototypeOf(Carousel)).call(this, props));
  ...
  _createClass$c(Carousel, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          otherProps = _objectWithoutProperties$e(_props, ["className", "index", "items", "renderItems", "onSwipe", "animationDuration"]);
